...
import { ICardCoinContainerProps, TLabelInchesColor } from '../../entities/Player';

const labelInchesColor: TLabelInchesColor | any = {
...
export const Container = styled.div<ICardCoinContainerProps>`
  ...
  .header {
    ...
    div {
      border-radius: 100px;
      background-color: ${({ colorInches }) => labelInchesColor[colorInches]};
      span {
        color: ${Colors.white};
